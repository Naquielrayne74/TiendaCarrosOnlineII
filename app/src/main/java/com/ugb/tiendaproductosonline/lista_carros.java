...
public class lista_carros extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbProductos = new DB_carros(lista_carros.this,"",null,1);
            ...
            if(cProductos.moveToFirst()){ //hay registros pendientes de sincronizar
                ...
                do{
                    ...
                    if (respuestaJSONObject.getBoolean("ok")) {
                        DB_carros db = new DB_carros(getApplicationContext(), "", null, 1);
    ...
    private void eliminarProductos(){
        try {
            AlertDialog.Builder confirmacion = new AlertDialog.Builder(lista_carros.this);
