...
public class DB_carros extends SQLiteOpenHelper {
    ...
    public DB_carros(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
